      ...
      <div class="space-y-3">
        ...
        <details class="rounded-md border p-3" open>
          ...
          <div class="mt-3 space-y-2">
            <div class="flex flex-wrap gap-2">
              <Button :variant="staticWrite ? 'default' : 'outline'" size="sm" @click="staticWrite = !staticWrite">
                write
              </Button>
            </div>
            <div class="flex flex-wrap gap-2">
        ...
        <details class="rounded-md border p-3">
          ...
          <div class="mt-3 space-y-2">
            <div class="flex flex-wrap gap-2">
              <Button :variant="dynamicWrite ? 'default' : 'outline'" size="sm" @click="dynamicWrite = !dynamicWrite">
                write
              </Button>
            </div>
            <div class="flex flex-wrap gap-2">
        ...
        <details class="rounded-md border p-3">
          ...
          <div class="mt-3 space-y-3">
            <div class="flex flex-wrap gap-2">
              <Button :variant="taskListen ? 'default' : 'outline'" size="sm" @click="taskListen = !taskListen">
                listen
              </Button>
            </div>
        ...
        <details class="rounded-md border p-3">
          ...
          <div class="mt-3 flex flex-wrap gap-2">
            <Button :variant="crontabRead ? 'default' : 'outline'" size="sm" @click="crontabRead = !crontabRead">
              read
            </Button>
            <Button :variant="crontabWrite ? 'default' : 'outline'" size="sm" @click="crontabWrite = !crontabWrite">
              write
            </Button>
            <Button :variant="crontabDelete ? 'default' : 'outline'" size="sm" @click="crontabDelete = !crontabDelete">
              delete
            </Button>
          </div>
        </details>
